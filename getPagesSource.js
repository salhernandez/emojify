...
function StringToEmoji(document_root) {
    ...
    let originalText = "100 replace it";
    let tokenized = originalText.split(" ");
    ...
    tokenized.forEach((token, index) => {
        ...
        emojiJson.forEach(emoji => {
            ...
            if(tehee){
                tokenized[index] = emoji.emoji
            }
        });
    })

    // document_root.getElementsByTagName("p")[0].innerHTML = "100 replace it";
    document_root.getElementsByTagName("p")[0].innerHTML = tokenized.join(" ");
